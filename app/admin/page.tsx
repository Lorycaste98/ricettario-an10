    ...
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/" className="rounded-lg border border-gray-200 px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 transition-colors inline-flex items-center gap-2">
