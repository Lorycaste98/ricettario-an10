    ...
    >
      <div className="relative aspect-4/3 animate-pulse bg-white/12">
        <div className="absolute bottom-0 left-0 right-0 p-3 space-y-2">
          <div className="h-3.5 w-2/3 rounded-lg bg-white/20" />
          <div className="h-2.5 w-1/3 rounded-lg bg-white/15" />
        </div>
        <div className="absolute top-2.5 right-2.5 h-4 w-20 rounded-full bg-white/20" />
      </div>
    </div>
  );
}
